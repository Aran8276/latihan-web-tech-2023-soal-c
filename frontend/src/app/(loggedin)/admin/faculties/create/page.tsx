...
import { createFaculty, FacultiesRequest } from "../actions";
...
export default function CreateForm() {
  ...
  const createFunction = async (payload: FacultiesRequest) => {
    if (payload.faculty_name && payload.is_enabled) {
      setState({ loading: true, error: "" });
      const processCreate = await createFaculty(payload);
      ...
      toast("Fakultas berhasil ditambah!");
